...
run_doubletfinder_custom <- function(seu_sample_subset, multiplet_rate = NULL){
  ...
  # Print sample number
  # print(paste0("Sample ", unique(seu_sample_subset[['Sample_ID']]), '...........'))
  ...
  if(is.null(multiplet_rate)){
    ...
    multiplet_rates_10x <- data.frame('Multiplet_rate' = c(0.00200, 0.00320, 0.00400, 0.00720, 0.00800, 0.01040, 0.01600, 0.02400, 0.03200, 0.04000, 0.04200, 0.05000, 0.05320, 0.06000, 0.07000, 0.08000),
                                      'Loaded_cells' = c(725, 1160, 1450, 2610, 2900, 3770, 5800, 8700, 11600, 14500, 15225, 18125, 19285, 21750, 25375, 29000),
                                      'Recovered_cells' = c(500, 800, 1000, 1800, 2000, 2600, 4000, 6000, 8000, 10000, 10500, 12500, 13300, 15000, 17500, 20000))
